...
package com.crosig.contacts.service.persistence.impl;

import com.crosig.contacts.exception.NoSuchFooException;
import com.crosig.contacts.model.Foo;
import com.crosig.contacts.model.FooTable;
import com.crosig.contacts.model.impl.FooImpl;
import com.crosig.contacts.model.impl.FooModelImpl;
import com.crosig.contacts.service.persistence.FooPersistence;
import com.crosig.contacts.service.persistence.FooUtil;
import com.crosig.contacts.service.persistence.impl.constants.CROSIGPersistenceConstants;
...
public class FooPersistenceImpl
	...
	@Override
	@Reference(
		target = CROSIGPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = CROSIGPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
