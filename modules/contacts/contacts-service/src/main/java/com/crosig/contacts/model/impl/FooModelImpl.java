...
import com.crosig.contacts.model.FooModel;
...
/**
 * The base model implementation for the Foo service. Represents a row in the &quot;CROSIG_Foo&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	 ...
	 */
	public static final String TABLE_NAME = "CROSIG_Foo";
	...
	public static final String TABLE_SQL_CREATE =
		"create table CROSIG_Foo (uuid_ VARCHAR(75) null,fooId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,field1 VARCHAR(75) null,field2 BOOLEAN,field3 INTEGER,field4 DATE null,field5 VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP = "drop table CROSIG_Foo";

	public static final String ORDER_BY_JPQL = " ORDER BY foo.field1 ASC";

	public static final String ORDER_BY_SQL = " ORDER BY CROSIG_Foo.field1 ASC";
